...
def main():
    ...
    p.add_argument("-c", "--contents-only", action="store_true", help="If provided, render HTML without the roots")
    args = p.parse_args()
...
def tree(
    db, term, href="?id={curie}", title=None, predicate_ids=None, include_search=False, standalone=True,
):
